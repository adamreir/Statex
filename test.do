...
statex est est1 est2, label b(%3.2fc) paren(%3.2fc) indicate("Year FE=*.year" "indiv FE=*.id") nogap stat(N r2 M, label("Obs 2" R2 MMmm) format(%12.2fc %12.3fc %12.3fc)) numbers(noblank)
/*
statex midrule
